  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="absolute right-4 top-1/2 hidden h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full border border-hairline bg-black/60 text-xl backdrop-blur-sm transition hover:border-white/60 hover:bg-black/80 sm:flex"
      >
