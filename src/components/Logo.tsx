...
export default function Logo({ className = '' }: { className?: string }) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M16.4285 55.0612v183.8885l81.7185-45.9721 42.8031-24.0792v-43.7854l-42.8031-24.0791zm124.5216 70.0515 38.916 21.8928V55.0612h-38.916zm38.916 21.8928-38.916 21.8927v70.0515h38.916z" />
